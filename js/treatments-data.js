...
const TREATMENTS_DATA = [
  ...
  // =========================================================================
  {
    ...
    name: "24K Ayurvedic Gold Glow Ritual",
    subtitle: "Precious Gold Leaf & Kumkumadi Saffron Infusion",
    duration: "90 Mins",
    priceMUR: 4800,
    priceUSD: 108,
    badge: "Bridal & Luxury",
    ...
    description: "An opulent royal beautifying ceremony using 24-karat edible gold leaves, pure Kashmiri saffron, and potent wild herb serums to impart an ethereal luminosity and velvety softness to the skin.",
    benefits: [
      "Stimulates collagen synthesis and cellular renewal",
      "Imparts unmatched luminous natural radiance",
      "Reduces fine lines, hyperpigmentation & sun damage",
      "Hydrates deeply with pure organic nectar"
    ],
    doshaFocus: "Pitta & Vata Enhancing",
    recommendedFor: "Weddings, special occasions, dull tired skin, luxury pampering"
  },
  {
    id: "beauty-02",
    categoryId: "beauty-care",
    categoryName: "Beauty Care",
    name: "Sandalwood & Turmeric Radiance Polish",
    subtitle: "Traditional Ubtan Body Exfoliation & Mask",
    duration: "60 Mins",
    priceMUR: 3100,
    priceUSD: 69,
    badge: "Best Seller",
    requiresDoctorConsultation: false,
    image: "assets/images/facial.jpg",
    description: "Ancient Indian royal ubtan formula featuring Mysore sandalwood paste, wild Kasturi turmeric, chickpea flour, and rose water that gently buffs dead cells and unveils supple, glowing skin.",
    benefits: [
      "Brightens skin tone and removes tan",
      "Exfoliates gently without stripping natural lipids",
      "Antibacterial and soothing for sensitive skin",
      "Leaves skin silky smooth and fragranced with sandalwood"
    ],
    doshaFocus: "All Skin Types",
    recommendedFor: "Sun-tanned skin, uneven complexion, pre-event glow"
  },
  {
    id: "beauty-03",
    categoryId: "beauty-care",
    categoryName: "Beauty Care",
    name: "Ayurvedic Botanical Detox Body Wrap",
    subtitle: "Herbal Clay & Sea Mineral Cocoon",
    duration: "75 Mins",
    priceMUR: 3600,
    priceUSD: 80,
    badge: "Detoxifying",
    requiresDoctorConsultation: false,
    image: "assets/images/facial.jpg",
    description: "Envelop your body in a warm cocoon of therapeutic Ayurvedic clay, spirulina, neem, and essential botanicals that draw out deep impurities while infusing skin with essential minerals.",
    benefits: [
      "Flushes out toxins and minimizes water retention",
      "Tones, firms, and tightens skin texture",
      "Deeply cleanses congested pores",
      "Leaves body visibly sculpted and energized"
    ],
    doshaFocus: "Kapha Detoxification",
    recommendedFor: "Fluid retention, cellulite toning, post-holiday detox"
  },
  {
    id: "beauty-04",
    categoryId: "beauty-care",
    categoryName: "Beauty Care",
    name: "Rose Quartz & Lotus Velvet Cocoon",
    subtitle: "Soothing Floral Hydration & Heart Chakra Blessing",
    duration: "75 Mins",
    priceMUR: 3700,
    priceUSD: 82,
    ...
    requiresDoctorConsultation: false,
    image: "assets/images/facial.jpg",
    description: "A deeply nourishing ritual with sacred Indian lotus oil, pure damask rose water, and rose quartz crystals to rehydrate parched skin and awaken self-love.",
    benefits: [
      "Deep moisture infusion for thirsty, parched skin",
      "Calms skin redness, sensitivity, and irritation",
      "Elevates mood with soothing natural floral aromatics",
      "Leaves the skin satin-soft and luminous"
    ],
    doshaFocus: "Pitta Soothing",
    recommendedFor: "Dry skin, sun exposure recovery, sensitive delicate skin"
  },
  ...
  // =========================================================================
  {
    ...
    name: "Mukha Lepam Ayurvedic Herbal Facial",
    subtitle: "Custom Herb Paste Facial with Marma Point Massage",
    duration: "60 Mins",
    priceMUR: 2800,
    priceUSD: 62,
    badge: "Classical Ayurvedic",
    requiresDoctorConsultation: false,
    image: "assets/images/facial.jpg",
    description: "A classical Ayurvedic facial beginning with an herbal steam and gentle cleansing, followed by facial marma massage with Kumkumadi oil, finished with a fresh custom-blended herbal paste (Lepam).",
    benefits: [
      "Firms facial muscles and restores elasticity",
      "Clears blemishes and enhances natural complexion",
      "Stimulates lymphatic drainage to de-puff face and eyes",
      "Protects against environmental pollution damage"
    ],
    doshaFocus: "Customized to Your Dosha",
    recommendedFor: "Puffy eyes, dull complexion, premature fine lines, daily rejuvenation"
  },
  {
    id: "face-02",
    categoryId: "face-care",
    categoryName: "Face Care",
    name: "Soundarya Age-Defying Kansa Facial",
    subtitle: "Bronze Wand Sculpting & Saffron Elixir",
    duration: "75 Mins",
    priceMUR: 3600,
    priceUSD: 80,
    badge: "Anti-Aging",
    requiresDoctorConsultation: false,
    image: "assets/images/facial.jpg",
    description: "Utilizes the sacred Ayurvedic Kansa wand (copper & tin alloy) to stimulate facial reflex points, sculpt jawline contours, boost collagen production, and draw out acidic toxins from the skin.",
    benefits: [
      "Natural holistic face-lift and jawline sculpting",
      "Diminishes fine lines and dark under-eye circles",
      "Balances skin pH and reduces inflammation",
      "Enhances micro-circulation for a lit-from-within glow"
    ],
    doshaFocus: "Vata & Pitta Skin",
    recommendedFor: "Mature skin, loss of firmness, crow's feet, under-eye bags"
  },
  {
    id: "face-03",
    categoryId: "face-care",
    categoryName: "Face Care",
    name: "Neem & Tulsi Purifying Acne Treatment",
    subtitle: "Deep Pore Clarifying & Anti-Bacterial Care",
    duration: "60 Mins",
    priceMUR: 2600,
    priceUSD: 58,
    badge: "Acne Clarifying",
    requiresDoctorConsultation: false,
    image: "assets/images/facial.jpg",
    description: "An intensive botanical clarifying treatment combining organic Neem, Holy Basil (Tulsi), tea tree, and cooling Aloe Vera to calm active breakouts, regulate sebum, and heal acne scars.",
    benefits: [
      "Eradicates acne-causing bacteria naturally",
      "Controls excess oil and minimizes enlarged pores",
      "Calms inflammation and redness without drying skin",
      "Accelerates healing of post-blemish dark spots"
    ],
    doshaFocus: "Pitta & Kapha Skin",
    recommendedFor: "Oily, acne-prone, congested, or reactive skin"
  },
  {
    id: "face-04",
    categoryId: "face-care",
    categoryName: "Face Care",
    name: "Aloevera & Cucumber Hydrating Glow",
    subtitle: "Cooling Moisture Replenishment for Sensitive Skin",
    duration: "45 Mins",
    priceMUR: 2200,
    priceUSD: 49,
    ...
    requiresDoctorConsultation: false,
    image: "assets/images/facial.jpg",
    description: "A refreshing burst of organic aloe vera gel, cold-pressed cucumber extract, and pure rose water designed to soothe sun-kissed skin and instantly restore moisture balance.",
    benefits: [
      "Instant cooling and hydration for dehydrated skin",
      "Soothes sunburn and tropical humidity redness",
      "Restores dewy skin texture and bounce",
      "Gentle and 100% hypoallergenic"
    ],
    doshaFocus: "Pitta Calming",
    recommendedFor: "Dehydrated skin, post-beach sun care, sensitive skin"
  },
